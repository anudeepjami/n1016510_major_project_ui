...
import { EventContract } from '../components/ethereum_connectors/eventcontract';
...
function CrowdfundingEventPage() {
    ...
    const [eventcontract, setEventcontract] = useState(EventContract(cookies.EventAddress));
    ...
    var LoadFundDetails = async () => {
        setFundDetails(await eventcontract.methods.GetCrowdfundingEventDetails().call());
        setVotingEventDetails(await eventcontract.methods.GetVotingEvents().call());
    }
    ...
    var ContributeFunds = async () => {
        ...
        try {
            ...
            setPopup(true);
            const temp = await eventcontract.methods
        ...
        <>
            <div style={{ width: "60%", margin: "0 auto" }}>
                ...
                <Card>
                    ...
                    <Card.Body>
                        <Card.Title>Managers Wallet address</Card.Title>
                        <Card.Text>
                            {fundDetails[2]}
                        </Card.Text>
                    </Card.Body>
                ...
                <Card>
                    ...
                    <Card.Body>
                        <Card.Title>Deposits should be made equal to or in multiples of the following Ether</Card.Title>
                        <Card.Text>
                            {web3.utils.fromWei(fundDetails[3] == undefined ? '0' : fundDetails[3].toString(), 'ether') + " eth"}
                            <br /><br />
                            <Button variant="primary" type="submit" onClick={() => { setViewContributeButton(!viewContributeButton) }}>
                                {!viewContributeButton ? 'Click to contribute' : 'Hide Contribution Form'}</Button>
                            <br /><br />
                ...
                <Card>
                    ...
                    <Card.Body>
                        <Card.Title>Funds remianing in event wallet</Card.Title>
                        <Card.Text>
                            {web3.utils.fromWei(fundDetails[6] == undefined ? '0' : fundDetails[6].toString(), 'ether') + " eth"}
                        </Card.Text>
                    </Card.Body>
                </Card>
                <br />
                <Card>
                    ...
                    <Card.Body>
                        <Card.Title>Total Number of Contributors and Votes</Card.Title>
                        <Card.Text>
                            {fundDetails[4]?.length + ' contributors have ' + fundDetails[5] + ' votes.'}
                            <br /><br />
                ...
                <Card>
                    ...
                    <Card.Body>
                        <Card.Title>Voting events taking place in this crowdfunding event</Card.Title>
                        <Card.Text>
                            {fundDetails[7]}
                            <br /><br />
                            <Button variant="primary" type="submit" onClick={() => { setViewCreateVotingEventForm(!viewCreateVotingEventForm) }}>
                                {!viewCreateVotingEventForm ? 'View create voting event form' : 'Hide create voting event form'}</Button>
                            <br /><br />
                            ...
                            <Button variant="primary" type="submit" onClick={() => { setViewVotingEventsTable(!viewVotingEventsTable) }}>
                                {!viewVotingEventsTable ? 'View' : 'Hide'} Voting Events Table</Button>
                            <br />
